...
import 'package:flutter_tiktok/utils/color_trans_util.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.title != null) {
      ...
      if (opacity >= 0.0) {
        ...
        TextStyle titleStyle = theme.primaryTextTheme.subtitle1;
        titleStyle = titleStyle.copyWith(
          ///设置颜色随着滑动距离的变化而变化
          color: ColorTransUtil.computeColor(Colors.white, Colors.black, t)
        );
